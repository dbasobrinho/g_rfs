set echo on
SET TIMING ON
EXEC dbms_application_info.set_module( module_name => 'coe_Y_coleta_info! WORKING -> ', action_name =>  'coe_Y_coleta_info');
...
SELECT 'coe_Y_coleta_info_'||TO_CHAR(SYSDATE, 'YYYYMMDD_HH24MISS')||'.csv' as fn from dual;
spool &BANCO;
