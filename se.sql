...
PROMPT
PROMPT +------------------------------------------------------------------------+
PROMPT | Report   : Active Sessions Oracle              +-+-+-+-+-+-+-+-+-+-+   |
...
SET COLSEP '|'
select count(*) qtde, inst_id, service_name, sql_id from gv$session WHERE sql_id = '3f4h2y7dc9x8q' group by inst_id, service_name, sql_id
/
