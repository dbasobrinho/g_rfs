...
---------------------------------------------------------------------------------------
set verify off lines 200 pages 999
col sql_text format a70 trunc
col child format 99999
col execs format 99,999,999
col avg_etime format 99,999.999999
col "IO_SAVED_%" format 99,999.99
...
accept sql_text char prompt "Enter SQL TEXT ==> " 

select sql_id, child_number child, inst_id, plan_hash_value plan_hash, executions execs, 
...
set verify on lines 200 pages 100