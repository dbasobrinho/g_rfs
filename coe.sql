...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('REM   GUINA_sql_profile_&&sql_id._&&plan_hash_value..sql');
  DBMS_OUTPUT.PUT_LINE('REM');
  DBMS_OUTPUT.PUT_LINE('REM DESCRIPTION');
  DBMS_OUTPUT.PUT_LINE('REM   This script is generated by GUINA_sql_profile.sql');
  ...
  DBMS_OUTPUT.PUT_LINE('REM   SQL> START GUINA_sql_profile_&&sql_id._&&plan_hash_value..sql;');
  DBMS_OUTPUT.PUT_LINE('REM');
