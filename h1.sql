...
@ashtop username,event2,sql_id,sql_opname,wait_class "wait_class in('Cluster', 'Network', 'Concurrency')" "timestamp'2020-07-28 19:10:00'" "timestamp'2020-07-28 19:20:00'"
...
exec dbms_application_info.set_module( module_name => 'BINO. .[h1.sql] >> E UMA CILADA [BINO]', action_name =>  'BINO. .[h1.sql] >> E UMA CILADA [BINO]');
