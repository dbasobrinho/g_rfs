...
PROMPT 
PROMPT +------------------------------------------------------------------------+
PROMPT | Report   : Informações básicas do banco de dados (primary or standby)  |
...
COLUMN INSTANCE               FORMAT a10        HEAD 'INSTANCE'                   justify CENTER 
COLUMN DATABASE_ROLE          FORMAT a17        HEAD 'DATABASE|ROLE'              justify CENTER 
COLUMN DB_UNIQUE_NAME         FORMAT a10        HEAD 'DB_UNIQUE_NAME'             justify CENTER 
COLUMN OPEN_MODE              FORMAT a12        HEAD 'OPEN_MODE'                  justify CENTER 
COLUMN PROTECTION_MODE        FORMAT a25        HEAD 'PROTECTION|MODE'            justify CENTER 
COLUMN PROTECTION_LEVEL       FORMAT a25        HEAD 'PROTECTION|LEVEL'           justify CENTER 
