...
# Usage: perl cpu_per_db_sort.pl [Interval [Count]] [top=] [displayuser=[Y|N]] [displaycmd=[Y|N]] 
#        perl cpu_per_db_sort.pl help 
#        perl cpu_per_db_sort.pl displayuser=Y displaycmd=Y
#        perl cpu_per_db_sort.pl 10 06 displayuser=Y displaycmd=Y top=20
#----------------------------------------------------------------#
