--## 
-- -------------------------------------------------------------------------------------------------
-- Nome do Arquivo : https://github.com/dbasobrinho/g_gold/blob/main/tun_plan.display_cursor.sql
-- Autor           : Roberto Fernandes Sobrinho	
-- Descrição       : Exibe Plano de Acesso com sequencia de execução
-- Requisitos      : DBA
-- Sintaxe Chamada : @tun_plan.display_cursor.sql
...
PROMPT
PROMPT +-------------------------------------------------------------------------------------------+
PROMPT | https://github.com/dbasobrinho/g_gold/blob/main/tun_plan.display_cursor.sql               |
PROMPT +-------------------------------------------------------------------------------------------+
...
--========================================================================
SELECT * FROM TABLE (dbms_xplan.display_cursor('&XX_SQLID','&XX_CHILD_NUM','&XX_FORMAT'));
--========================================================================
UNDEF XX_FORMAT
UNDEF XX_SQLID
UNDEF XX_CHILD_NUM
