-- |----------------------------------------------------------------------------|
-- | DATABASE : Oracle                                                          |
-- | FILE     : tbs_block_free_datafile_order                                   |
-- | CREATOR  : DANIEL LUCIANO                                                  |
-- | DATE     : 14/03/2019                                                      |
-- +----------------------------------------------------------------------------+
...
PROMPT 
PROMPT +------------------------------------------------------------------------+
PROMPT | Report   : BLOCOS LIVRES TABLESPACE ORDER DATAFILE                     |
...
---where z.FILE_ID = 33
--z.block_id >= 10884392 and z.block_id <= 10884499
/
