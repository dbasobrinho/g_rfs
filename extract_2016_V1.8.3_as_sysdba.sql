...
prompt *                                                                              *
prompt *  Versão 1.8.2 - Inmetrics 2016                                               *
prompt *                                                                              *
prompt ********************************************************************************
prompt
prompt ********************************************************************************
...
prompt *  1.7.3   *  04/01/2016  *  Danilo Mendes    *  Erro numérico (resourcelimit) *
prompt *  1.8.1   *  18/08/2016  *  Danilo Mendes    *  Análise de Advisors/HA e Bugs *
prompt *  1.8.2   *  19/10/2016  *  Danilo Mendes    *  PHYSICAL_MEMORY_BYTES         *
prompt *  1.8.3   *  02/10/2017  *  Douglas Romero   *  SetBlankLines = ON            *
prompt ********************************************************************************
prompt
...
exec select to_char( trunc(sysdate -1, 'dd') ,&date_mask) into :begin_date_default from dual;
...
@pga_advisor.csv
prompt *                                                                              *
prompt *  Caso PHYSICAL_MEMORY_BYTES=0 na gv$osstat Insira memória em Megabytes)      *
prompt *  Valor default: 0                          (deixar em branco para aceitar)   *
ACCEPT MEMORY_MB PROMPT '*  Novo valor : ' DEFAULT 0
prompt *                                                                              *
...
with hw as
  (select i.inst_id,
    ...
    CASE WHEN ROUND(o1.value/1024/1024) = 0 THEN TO_NUMBER(&MEMORY_MB) ELSE ROUND(o1.value/1024/1024) END memory,
...
with hw as
  ...
  select db.instance_number inst_id,
      ...
      round(max(db.physical_reads/decode(f1.physical_reads,0,1))-1,2) fator_physical_reads      
