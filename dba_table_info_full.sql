...
COLUMN LOW_VALUE           FORMAT a30                HEADing "Low|Value"              JUSTIFY CENTER
COLUMN HIGH_VALUE          FORMAT a30                HEADing "High|Value"             JUSTIFY CENTER
...
COLUMN DENSITY             FORMAT a35                HEADING "Density|-"                 JUSTIFY CENTER
...
SELECT C.COLUMN_NAME, C.HISTOGRAM, C.NUM_DISTINCT, C.LOW_VALUE, C.HIGH_VALUE,
           C.NUM_NULLS,
           C.NUM_BUCKETS,
...
COLUMN index_name          FORMAT a40            HEADING "Index|Name"      JUSTIFY CENTER
COLUMN TABLESPACE_NAME     FORMAT a25            HEADING "Tablespace|Name"      JUSTIFY CENTER
COLUMN BLEVEL              FORMAT 99999999999    HEADING "Blevel|"          JUSTIFY CENTER
COLUMN LEAF_BLOCKS         FORMAT 99999999999    HEADING "Leaf|Blocks"     JUSTIFY CENTER
...
COLUMN NUM_ROWS            FORMAT 99999999       HEADING "Num|Rows"        JUSTIFY CENTER
COLUMN LAST_ANALYZED       FORMAT a19                HEADING "Last|Analyzed"           JUSTIFY CENTER
COLUMN status                                        HEADING "Status|"  JUSTIFY CENTER

SELECT
    OWNER || '.' || index_name  index_name, STATUS
  , TABLESPACE_NAME
  , BLEVEL
  , LEAF_BLOCKS
  , DISTINCT_KEYS
