...
col INDEX_OWNER      format a15 HEADING 'INDEX OWNER'
...
select decode( b.table_name, NULL, '****', 'ok' ) Status, b.INDEX_OWNER, b.index_name, a.columns CONS_COLUMNS, b.columns IDX_COLUMNS
from
