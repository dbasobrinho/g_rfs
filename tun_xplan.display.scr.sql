--## 
-- -------------------------------------------------------------------------------------------------
-- Nome do Arquivo : https://github.com/dbasobrinho/g_gold/blob/main/tun_xplan.display.scr.sql
-- Autor           : Roberto Fernandes Sobrinho	
-- Descrição       : Exibe Plano de Acesso com sequencia de execução
-- Requisitos      : DBA
-- Sintaxe Chamada : @tun_xplan.display.scr.sql
-- Dependência     : tun_xplan.display.root.sql
...
PROMPT
PROMPT +-------------------------------------------------------------------------------------------+
PROMPT | https://github.com/dbasobrinho/g_gold/blob/main/tun_xplan.display.scr.sql                 |
PROMPT +-------------------------------------------------------------------------------------------+
PROMPT | Report   : XPLAN.DISPLAY (tun_xplan.display.root.sql)            +-+-+-+-+-+-+-+-+-+-+-+  |
...
--========================================================================
@tun_xplan.display.root.sql '&XX_SQLID' '&XX_CHILD_NUM' "&XX_FORMAT"
