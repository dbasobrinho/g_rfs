--------------------------------------------------------------------------------
--
-- File name:   hora.sql versão 1.3
-- Purpose:     Exibe as métricas da DBA_HIST_SYSMETRIC_SUMMARY/V$SYSMETRIC_HISTORY
--              mais importante, com gráficos de comparação entre os periodos
--              
--              
--------------------------------------------------------------------------------
...
col TIME_INTERVAL           heading "INTERVALO" FORMAT  a20
...
col "TIME_INTERVAL  -24H"   heading "INTERVALO -24H" format a20
col "TIME_INTERVAL   -1H"   heading "INTERVALO  -1H" like "TIME_INTERVAL  -24H"
col "TIME_INTERVAL"         heading "INTERVALO"      like "TIME_INTERVAL  -24H" 
...
from  (
   ...
   NULLIF(SUM(DECODE(METRIC_NAME, 'Logical Reads Per User Call', VALUE, 0)),0) "READS/CALL",
   ...
   FROM
&is_cdb &is_root             V$SYSMETRIC_HISTORY SMH
&is_not_cdb                  V$SYSMETRIC_HISTORY SMH
&is_cdb &is_not_root         V$CON_SYSMETRIC_HISTORY SMH
   WHERE
&is_cdb &is_root             SMH.GROUP_ID = 2
&is_not_cdb                  SMH.GROUP_ID = 2
&is_cdb &is_not_root         SMH.GROUP_ID = 18
