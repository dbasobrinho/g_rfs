----------------------------------------------------------------------------------------
--
-- File name:   coe_unstable_plans.sql
--
...
PROMPT 'INPUT COM O START_TIME (in format DD/MM/YYYY HH24:MI) >> OPTIONAL: '

ACCEPT END_TIME CHAR FORMAT 'A20' -
PROMPT 'INPUT END_TIME   (in format DD/MM/YYYY HH24:MI) >> OPTIONAL: '
...
and executions_delta > 0
                and ss.BEGIN_INTERVAL_TIME >= to_date('&&START_TIME','DD/MM/YYYY HH24:MI')
                and ss.END_INTERVAL_TIME   <= to_date('&&END_TIME','DD/MM/YYYY HH24:MI')
