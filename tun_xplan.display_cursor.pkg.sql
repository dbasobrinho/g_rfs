--## 
-- -------------------------------------------------------------------------------------------------
-- Nome do Arquivo : https://github.com/dbasobrinho/g_gold/blob/main/tun_xplan.display_cursor.pkg.sql
-- Autor           : Roberto Fernandes Sobrinho	
-- Descrição       : Exibe Plano de Acesso com sequencia de execução
-- Requisitos      : DBA
-- Sintaxe Chamada : @tun_xplan.display_cursor.pkg.sql
-- Dependência     : Package: xplan, Instalação: tun_xplan.package.install.sql
...
PROMPT
PROMPT +-------------------------------------------------------------------------------------------+
PROMPT | https://github.com/dbasobrinho/g_gold/blob/main/tun_xplan.display_cursor.pkg.sql          |
PROMPT +-------------------------------------------------------------------------------------------+
PROMPT | Report   : XPLAN.DISPLAY_CURSOR (@tun_xplan.package.install.sql) +-+-+-+-+-+-+-+-+-+-+-+  |
...
--@xplan.display.sql '&XX_SQLID' '&XX_CHILD_NUM' "&XX_FORMAT"
--========================================================================
UNDEF XX_FORMAT
UNDEF XX_SQLID
UNDEF XX_CHILD_NUM
