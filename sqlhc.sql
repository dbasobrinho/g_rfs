...
host mkdir ^^files_prefix

SELECT '^^files_prefix/^^files_prefix.' files_prefix FROM DUAL;
...
PRO
HOS unzip -l &&files_prefix..zip
host unzip &&files_prefix..zip
host mv ^^sqlhc_^^sql_id.out ^^files_prefix
CL COL;
