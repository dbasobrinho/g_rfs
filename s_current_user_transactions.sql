...
SELECT
  ...
  , TO_CHAR(c.logon_time,'mm/dd/yy hh24:mi:ss')  logon_time
  , b.owner                         owner
...
COLUMN number_of_undo_records   FORMAT 999,999,999      HEADING '# Undo Records'
...
COLUMN logical_io_size          FORMAT     999,999,999  HEADING 'Logical|I/O (MB)' 
COLUMN physical_io_blks         FORMAT     999,999,999  HEADING 'Physical|I/O (Blks)'
COLUMN physical_io_size         FORMAT     999,999,999  HEADING 'Physical|I/O (MB)'
COLUMN session_program          FORMAT a16              HEADING 'Session|Program'       TRUNC
...
SELECT
  ...
  , p.spid                              os_pid
  , TO_CHAR(TO_DATE(b.start_time,'mm/dd/yy hh24:mi:ss'), 'mm/dd/yy hh24:mi:ss')   trnx_start_time
