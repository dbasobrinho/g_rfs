...
PROMPT
PROMPT +-----------------------------------------------------------------------------+
PROMPT | eXplain from Memory with Statistics lookup by Hash value                    |
PROMPT +-----------------------------------------------------------------------------+
PROMPT
...
column xms_opt_cost     heading Optimizer|Cost for 9999999999
column xms_opt_card     heading "Estimated|output rows" for 99999999999
column xms_opt_bytes        heading "Estimated|output bytes" for 99999999999
column xms_predicate_info   heading "Predicate Information (identified by operation id):" format a100 word_wrap
column xms_cpu_cost     heading CPU|Cost for 999999
column xms_io_cost      heading IO|Cost for 999999

column xms_last_output_rows heading "Real #rows|returned" for 99999999
column xms_last_starts          heading "Rowsource|starts" for 99999999
column xms_last_cr_buffer_gets  heading "Consistent|gets" for 99999999
column xms_last_cu_buffer_gets  heading "Current|gets" for 99999999
column xms_last_disk_reads      heading "Physical|reads" for 99999999
column xms_last_disk_writes     heading "Physical|writes" for 99999999
