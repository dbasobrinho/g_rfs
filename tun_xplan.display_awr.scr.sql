--## 
-- -------------------------------------------------------------------------------------------------
-- Nome do Arquivo : https://github.com/dbasobrinho/g_gold/blob/main/tun_xplan.display_awr.scr.sql
-- Autor           : Roberto Fernandes Sobrinho	
-- Descrição       : Exibe Plano de Acesso com sequencia de execução
-- Requisitos      : DBA
-- Sintaxe Chamada : @tun_xplan.display_awr.scr.sql
-- Dependência     : tun_xplan.display_awr.root.sql
...
PROMPT
PROMPT +-------------------------------------------------------------------------------------------+
PROMPT | https://github.com/dbasobrinho/g_gold/blob/main/tun_xplan.display_awr.scr.sql             |
PROMPT +-------------------------------------------------------------------------------------------+
PROMPT | Report   : XPLAN.DISPLAY_AWR (tun_xplan.display_awr.root.sql)    +-+-+-+-+-+-+-+-+-+-+-+  |
...
--========================================================================
@tun_xplan.display_awr.root.sql '&XX_SQLID' '&XX_CHILD_NUM' "&XX_FORMAT"


--SELECT * FROM TABLE (xplan.display('e_XX_SQLID','e_XX_CHILD_NUM','e_XX_FORMAT'));
