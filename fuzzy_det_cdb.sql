...
-- | Data       : 24/01/2025                                                                   |
-- | Exemplo    : @fuzzy_det_cdb.sql                                                           |  
-- | Arquivo    : fuzzy_det_cdb.sql                                                            |
...
PROMPT
PROMPT +-------------------------------------------------------------------------------------------+
PROMPT | https://github.com/dbasobrinho/g_gold/blob/main/fuzzy_det_cdb.sql                         |
PROMPT +-------------------------------------------------------------------------------------------+
...
-- Consulta para verificar cabeçalhos de arquivos de dados
select CON_ID, a.status,to_char(a.checkpoint_change#) checkpoint_change
 ...
 order by CON_ID,a.checkpoint_change#,a.checkpoint_time, a.FILE#
/