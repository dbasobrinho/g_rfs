...
-- Call Syntax  : job_run_details_full_info (job-name | all)
...
COLUMN additional_info FORMAT A10
PROMPT .
PROMPT . .
PROMPT . . .
ACCEPT j_name char   PROMPT 'JOB_NAME or ALL = '

select z.log_date, z.owner_10, z.job_name, z.status, z.req_start_date, z.actual_start_date, z.run_duration, z.additional_info 
from(
