...
--
-- Example:
--     @ashtop_gv.sql username,sql_id session_type='FOREGROUND' sysdate-1/24 sysdate
--
-- Other:
...
exec dbms_application_info.set_module( module_name => 'ASHGV >> APROVEITA QUE TA VAZI [rfs]', action_name =>  'ASHGV >> APROVEITA QUE TA VAZI [rfs]');
set timing on
