...
spool redo_analysis_database.out
...
select owner, object_type, status, count(1) from dba_objects group by owner, object_type,status order by 1,2;

select owner, segment_name, segment_type, partition_name, sum(bytes/1024/1024) from dba_segments group by owner, segment_name, segment_type, partition_name order by 5 desc;

select tablespace_name, sum(bytes/1024/1024) from dba_segments group by tablespace_name;


select a.INST_ID, a.group#,a.THREAD#,SEQUENCE#,a.status,a.bytes/1024/1024 MB, b.MEMBER, b.TYPE--, a.BLOCKSIZE
from gv$log a,
gv$logfile b
...
select group#,THREAD#, sequence#,bytes/1024/1024,used,status from gv$standby_log;
